...
- (void)viewDidLoad {
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/NitaPreferences.bundle/welcome/header.png"]];
    ...
    [[self twitterCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/NitaPreferences.bundle/welcome/twitter.png"] forState:UIControlStateNormal];
    ...
    [[self githubCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/NitaPreferences.bundle/welcome/github.png"] forState:UIControlStateNormal];
    ...
    [[self discordCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/NitaPreferences.bundle/welcome/discord.png"] forState:UIControlStateNormal];
